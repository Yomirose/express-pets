...
var transport = nodemailer.createTransport({
  ...
  try {
    const promise1 = transport.sendMail({
        ...
        subject: `Thank you for your interest in the ${doesPetExist.name}`,
